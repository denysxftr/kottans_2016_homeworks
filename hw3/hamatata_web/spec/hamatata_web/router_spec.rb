...
RSpec.describe HamatataWeb::Router do

  subject do
    HamatataWeb::Router.new do
      # posts
    ...
    describe 'posts routes' do
      ...
      context 'shows a post with GET' do
        ...
        it 'by identify name' do
          env['REQUEST_PATH'], env['REQUEST_METHOD'] = '/posts/333', 'GET'
          expect(subject.call(env)).to eq [200, {}, ['shows a post']]
        end
        it 'by identify id' do
          env['REQUEST_PATH'], env['REQUEST_METHOD'] = '/posts/something', 'GET'
          expect(subject.call(env)).to eq [200, {}, ['shows a post']]
        end
      ...
      it 'updates a post with PUT' do
        env['REQUEST_PATH'], env['REQUEST_METHOD'] = '/posts/something', 'PUT'
        expect(subject.call(env)).to eq [200, {}, ['updates a post']]
      end

      it 'destroys a post with DELETE' do
        env['REQUEST_PATH'], env['REQUEST_METHOD'] = '/posts/something', 'DELETE'
